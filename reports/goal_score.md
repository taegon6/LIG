...
| --- | --- | --- |
| C:\Users\User\AppData\Local\Python\pythoncore-3.14-64\python.exe -m pytest | True | tests\test_red_readiness.py ....                                         [ 72%]<br>tests\test_rolling_metrics.py ..                                         [ 75%]<br>tests\test_scenario_stats.py ....                                        [ 82%]<br>tests\test_scoring.py ......                                             [ 91%]<br>tests\test_sla.py ..                                                     [ 95%]<br>tests\test_stress_scenarios.py ...                                       [100%]<br><br>============================= 62 passed in 12.87s ============================= |
