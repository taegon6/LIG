...
| --- | --- | --- |
| C:\Users\User\AppData\Local\Python\pythoncore-3.14-64\python.exe -m pytest | True | tests\test_red_readiness.py .....                                        [ 75%]<br>tests\test_rolling_metrics.py ..                                         [ 78%]<br>tests\test_scenario_stats.py ....                                        [ 84%]<br>tests\test_scoring.py ......                                             [ 92%]<br>tests\test_sla.py ..                                                     [ 95%]<br>tests\test_stress_scenarios.py ...                                       [100%]<br><br>============================= 70 passed in 16.20s ============================= |
| C:\Users\User\AppData\Local\Python\pythoncore-3.14-64\python.exe scripts/run_experiments.py --rounds 100 --seed 42 | True | average utility: 69.89<br>false positive rate: 0.0<br>recovery success rate: 1.0<br>scenario entropy: 71.9<br>coverage score: 100.0<br>round metrics CSV: reports\round_metrics.csv<br>scenario summary CSV: reports\scenario_summary.csv<br>red objective summary CSV: reports\red_objective_summary.csv |
