...
| --- | --- | --- |
| C:\Users\User\AppData\Local\Python\pythoncore-3.14-64\python.exe -m pytest | True | tests\test_red_readiness.py ....                                         [ 72%]<br>tests\test_rolling_metrics.py ..                                         [ 75%]<br>tests\test_scenario_stats.py ....                                        [ 82%]<br>tests\test_scoring.py ......                                             [ 91%]<br>tests\test_sla.py ..                                                     [ 95%]<br>tests\test_stress_scenarios.py ...                                       [100%]<br><br>============================= 62 passed in 11.42s ============================= |
| C:\Users\User\AppData\Local\Python\pythoncore-3.14-64\python.exe scripts/run_experiments.py --rounds 100 --seed 42 | True | average recovery delta: 8.0<br>average utility: 70.73<br>false positive rate: 0.0<br>recovery success rate: 1.0<br>scenario entropy: 64.3<br>coverage score: 100.0<br>round metrics CSV: reports\round_metrics.csv<br>scenario summary CSV: reports\scenario_summary.csv |
...
| red_readiness | True | {"plan": {"red_objective": "BLUE_MISMATCH", "event_type": "AUTH_ANOMALY", "intensity": 0.45, "strategy_reason": "Use event types that require distinct containment, decoy, or isolation actions.", "expected_effect": "Check whether Blue maps the latest safe anomaly to the correct response."}, "objective_names": ["BLUE_MISMATCH", "CONFUSION", "COVERAGE", "RECOVERY_PRESSURE", "SLA_DROP"], "objective_events": ["AUTH_ANOMALY", "LOG_NOISE", "MISSION_COMMAND_ANOMALY", "SERVICE_DEGRADATION", "TELEMETRY_INCONSISTENCY", "TRAFFIC_SPIKE"], "stats_status": 200, "stats_keys": ["average_recent_red_success_score", "coverage_score", "external_access", "local_only", "red_objectives", "safe_event_types", "scenario_entropy", "scenario_stats", "total_attempts"]} |
